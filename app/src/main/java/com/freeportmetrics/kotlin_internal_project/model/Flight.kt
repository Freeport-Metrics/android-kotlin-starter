...
data class Flight(
    ...
    @SerializedName("links") @Convert(converter = LinksConverter::class, dbType = String::class) val urls: Link?
) {
    data class Link(  // another class needed due to more complicated 'links' JSON
